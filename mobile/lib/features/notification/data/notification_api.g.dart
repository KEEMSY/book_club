...
class _NotificationApi implements NotificationApi {
  ...
  Future<WeeklyReportResponse> getWeeklyReport(String weekDate) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'week': weekDate};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<WeeklyReportResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/reports/weekly',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late WeeklyReportResponse _value;
    try {
      _value = WeeklyReportResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
