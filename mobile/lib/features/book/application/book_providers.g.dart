...
String _$bookReviewsHash() => r'eaf756973332479716e971e909bca8b443246058';
...
/// See also [bookReviews].
class BookReviewsFamily extends Family<AsyncValue<List<BookReview>>> {
  /// See also [bookReviews].
  const BookReviewsFamily();

  /// See also [bookReviews].
  BookReviewsProvider call(
    String bookId,
  ) {
    return BookReviewsProvider(
      bookId,
    );
  }
...
/// See also [bookReviews].
class BookReviewsProvider extends AutoDisposeFutureProvider<List<BookReview>> {
  /// See also [bookReviews].
  BookReviewsProvider(
    String bookId,
  ) : this._internal(
          (ref) => bookReviews(
            ref as BookReviewsRef,
            bookId,
          ),
          ...
          allTransitiveDependencies:
              BookReviewsFamily._allTransitiveDependencies,
          bookId: bookId,
        );
  ...
  Override overrideWith(
    FutureOr<List<BookReview>> Function(BookReviewsRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
      override: BookReviewsProvider._internal(
        (ref) => create(ref as BookReviewsRef),
        from: from,
        name: null,
        dependencies: null,
        allTransitiveDependencies: null,
  ...
  @override
  AutoDisposeFutureProviderElement<List<BookReview>> createElement() {
    return _BookReviewsProviderElement(this);
  }

  @override
  bool operator ==(Object other) {
    return other is BookReviewsProvider && other.bookId == bookId;
  }
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin BookReviewsRef on AutoDisposeFutureProviderRef<List<BookReview>> {
  /// The parameter `bookId` of this provider.
  String get bookId;
}

class _BookReviewsProviderElement
    extends AutoDisposeFutureProviderElement<List<BookReview>>
    with BookReviewsRef {
  _BookReviewsProviderElement(super.provider);

  @override
  String get bookId => (origin as BookReviewsProvider).bookId;
}
