...
class _CommunityApi implements CommunityApi {
  ...
  @override
  Future<PostPageDto> getFollowingFeed({String? cursor, int limit = 20}) async {
  ...
  @override
  Future<MyActivitySummary> getMyActivity() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MyActivitySummary>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MyActivitySummary _value;
    try {
      _value = MyActivitySummary.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
