...
- **0.1.6** (2026-04-25) — **Milestone 4 (Feed — 책 그룹 포스트 · 리액션 · 댓글) 완료.** 태그 `v0.0.5-m4`.
  ...
  - 새 의존성: `image_picker: ^1.1.2`.
  - 등급 영역 애니메이션도 같은 사이클에 추가 (mount entrance · idle glow pulse · 등급업 셀러브레이션 · GradeProgress 0→percent ease-out · MediaQuery.disableAnimations 존중).
